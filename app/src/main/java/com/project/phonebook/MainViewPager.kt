...
import com.project.phonebook.fragment.ContractDetailFragment
...
class MainViewPager(fragment: Fragment): FragmentStateAdapter(fragment) {
    //TODO: update list.
    private val pages = listOf<Fragment>(ContractListFragment(), MyPageFragment(), ContractDetailFragment())
